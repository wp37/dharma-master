...
5. **IMAGEN 3 IMAGE PROMPT**: For each scene, generate a high-quality English 'image_prompt' suitable for Google Imagen 3/Midjourney. Avoid generating any text or watermarks in the image. Focus on sacred Buddhist aesthetics, soft morning light, serene Zen atmosphere, temples, lotus flowers, deep meditation, or beautiful symbolic representations of mindfulness. Ensure it is highly detailed, photorealistic or high-end spiritual illustration style.
